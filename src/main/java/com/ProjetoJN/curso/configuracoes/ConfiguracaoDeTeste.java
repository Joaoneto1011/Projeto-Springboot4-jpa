...
public class ConfiguracaoDeTeste implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Pedido p1 = new Pedido(null, Instant.parse("2025-12-22T15:40:30Z"), u1);
		Pedido p2 = new Pedido(null, Instant.parse("2025-11-21T16:30:20Z"), u2);
		Pedido p3 = new Pedido(null, Instant.parse("2025-10-20T18:20:10Z"), u1);
